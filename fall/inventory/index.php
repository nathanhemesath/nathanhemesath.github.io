...
<html>
<head>
	<title>Fallout 4 Task Manager</title>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
	<meta name="description" content="Fallout 4 Task Manager" />
		...
		function add_task() {
			...
			$('.add-new-task').submit(function(){
				...
				if(new_task != ''){
					...
					$.post('/inventory/includes/add-task.php', { task: new_task }, function( data ) {
